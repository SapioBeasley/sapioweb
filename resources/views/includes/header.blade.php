	...
	<div id="navbar" class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		...
		<li class="dropdown mega-fw">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Home<span class="caret"></span></a>
		  <ul class="dropdown-menu">
			<div class="row">
			  ...
			  <div class="col-md-3 mb-sm-30">
				...
				<li><a href="index-app-landing.html" target="_blank">Mobile App <span class="label label-red">New</span></a></li>
				<li><a href="index-web-app-landing.html" target="_blank">Web App <span class="label label-red">New</span></a></li>
		...
		<!-- Elements -->
		<li class="dropdown">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Elements <span class="caret"></span></a>
		  <ul class="dropdown-menu">
			<div class="row">
			  ...
			  <div class="col-lg-6 mb-sm-30">
				...
				<li><a href="elements/hover.html" target="_blank"><i class="fa fa-image"></i> Hover <span class="label label-red">New</span></a></li>
			  </div>
		...
		<!-- Pages -->
		<li class="dropdown mega-fw">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Pages <span class="caret"></span></a>
		  <ul class="dropdown-menu">
			<div class="row">
		...
		<!-- Portfolio -->
		<li class="dropdown mega-fw">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Portfolio <span class="caret"></span></a>
		  <ul class="dropdown-menu">
			<div class="row">
			  ...
			  <div class="col-lg-3 mb-sm-30">
				...
				<li><a href="pages/portfolio/portfolio-single-3.html">Portfolio Single 3 <span class="label label-red">New</span></a></li>
				<li><a href="pages/portfolio/portfolio-single-4.html">Portfolio Single 4 <span class="label label-red">New</span></a></li>
			  </div>
		...
		<!-- Blog -->
		<li class="dropdown">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Blog <span class="caret"></span></a>
		  <ul class="dropdown-menu">
	  ...
	  <ul class="nav navbar-nav navbar-right">
		...
		<!-- Search -->
		<li class="dropdown">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-search"></i> Search</a>
		...
		<!-- Languages -->
		<li class="dropdown">
		  <a href="index-kenburn-mp.html#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">EN <span class="caret"></span></a>
		  <ul class="dropdown-menu">
			<li><a href="index-kenburn-mp.html#">DE</a></li>
			<li><a href="index-kenburn-mp.html#">FR</a></li>
			<li><a href="index-kenburn-mp.html#">ES</a></li>
		  </ul>
		</li><!-- / Languages -->
